# smart-plant-sprint3
ชื่อสมาชิก	Role	Module ที่ทำใน Day 2	Task ที่ทำ	Evidence Link / Screenshot / Commit	สถานะ
คชภัค เอี่ยมสอาด 	Embedded / IoT Develop	M3.1 ESP32 + Arduino	เขียน publisher อ่านค่าความชื้น,เขียน subscriber แจ้งเตือน	Screenshot	 Doing 
